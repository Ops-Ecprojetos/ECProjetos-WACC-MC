...
st.markdown("📈 Qual percentil usar e quando? Situação	Percentil recomendado	Justificativa Ambiente regulatório estável e maduro (baixo risco)	50% (média)	O risco de erro é pequeno, então usar a média é suficiente.
Concessões brownfield (ativos já existentes, com risco menor)	50% a 69%	O risco de subestimar o WACC é moderado. Concessões greenfield (ativos novos, com mais risco)	69% ou até 84%	Há mais incertezas, risco de obra atrasar, de demanda incerta, etc.
Ambiente regulatório instável ou de alta volatilidade econômica	84%	É melhor adotar uma posição conservadora para estimular investimentos. Projetos de altíssimo CAPEX (investimentos pesados, tipo portos, aeroportos grandes)	69% a 84%	A tolerância para subinvestimento é baixíssima; precisa proteger o projeto.")
)
